...
export default function VerifyEmail({ status }) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
            <Card className="max-w-md w-full shadow-2xl" noPadding={true}>
                <div className="p-8">
                    {/* Icon */}
                    ...
                    <p className="text-center text-gray-600 dark:text-gray-400 mb-6">
                        Thanks for signing up! We've sent you a verification
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-6">
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                            ...
                            link to continue. If you didn't receive the email,
