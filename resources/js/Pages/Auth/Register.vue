        ...
        <Card class="w-full max-w-md">
            ...
            <CardContent class="space-y-4">
                ...
                <a
                    ...
                    class="flex w-full items-center justify-center gap-2 rounded-lg border bg-background px-4 py-3 font-medium transition-colors hover:bg-accent"
                >
                ...
                <!-- Email/Password Form (placeholder for Fortify) -->
