...
export default function Index({ auth }) {
    ...
    const handleConnect = (platformId) => {
        ...
        alert(`Connecting to ${platformId}... (This is a mock action)`);
    };
        ...
        <DashboardLayout user={auth.user}>
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <button className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white transition-all transform rounded-lg bg-linear-to-r from-primary-600 to-purple-600 hover:from-primary-700 hover:to-purple-700 hover:scale-105 shadow-lg shadow-primary-500/30">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
                    {platforms.map((platform) => (
                        ...
                        >
                            ...
                            <div
                                className={`absolute inset-0 opacity-0 group-hover:opacity-5 transition-opacity duration-500 bg-linear-to-br ${platform.color}`}
                            />
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {platform.accounts.map(
                                                (account) => (
                                                    <div
                                                        key={account.id}
                                                        className="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-gray-900/50 hover:bg-gray-100 dark:hover:bg-gray-900 transition-colors group/account"
                                                    >
                                                        ...
                                                        <button className="text-gray-400 hover:text-red-500 dark:text-gray-600 dark:hover:text-red-400 opacity-0 group-hover/account:opacity-100 transition-opacity p-1">
                                                            <LinkOff className="w-4 h-4" />
                                                        </button>
                                                    </div>
                                                )
                                            )}
                                            <button className="w-full mt-2 py-2 text-xs font-medium text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 border border-dashed border-primary-200 dark:border-primary-800 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/10 transition-colors flex items-center justify-center gap-1">
